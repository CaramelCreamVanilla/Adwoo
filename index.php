    ...
    <img src="img/logo.png" alt="logo" class="logo">
      <form class="p-3"  method="post" >
          <div class="col-12 col-md-8 container">
              ...
              <button type="submit" name = "seach"class="fas fa-search btn" id="search-btn" action="seach_db.php"></button>
          </div>
      </form>
...
{ 
    ...
    <form action="brand_db.php" method="post" >
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"style="width: 1200px; height:360px">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/sell1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/sell2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/sell3.jpg" alt="Third slide">
    </div>
  </div>
