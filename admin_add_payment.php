      ...
      <form action="product_type_upload.php" method = "post">
        ...
        <div class="user-details">
          ...
          <div class = "center_status">
           <h2> <span class="details">เพิ่มบัญชี</span> </h2> 
            <br>
          </div>
            <br>
            <h3> <span class="details">ชื่อธนาคาร</span> </h3> 
            <input type="text" name="payment_type" placeholder="กรุณากรอกชื่อธนาคาร" required>
            <br>
            <br>
            <h3> <span class="details">เลขบัญชีธนาคาร</span> </h3> 
            <input type="text" name="bank_number" placeholder="กรุณาเลขบัญชี" required>
            <br>
            <br>
            <h3> <span class="details">ชื่อบัญชีธนาคาร</span> </h3> 
            <input type="text" name="bank_name" placeholder="กรุณาชื่อบัญชีธนาคาร" required>
          </div>
          <br>
          </div>
          <br>
        <button   type="submit" value = "upload" name = "payment_id"  class="uploadbtn">เพิ่มบัญชี</button>
      </form>
    </div>
  </div>
