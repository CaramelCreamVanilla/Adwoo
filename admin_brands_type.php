...
<div class="container">
    ...
    <input  name ="upload-img" id="default-btn" type="file" required >
        ...
        <div class="user-details">
          <div class="input-box">
            <span class="details">Name brand</span>
            <input type="text" id="nameproduct"name="name_brand" placeholder="Enter your name name_ty_prod" required >
          </div>
 
   


        <button   type="submit" value = "upload" name = "brands"  class="uploadbtn">เพิ่มแบรนด์</button>
