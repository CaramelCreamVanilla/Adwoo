...
<h2> Status รอชำระเงิน</h2>
<h2> <a href="admin_wallet_c.php">รอตรวจสอบภายหลัง</a></h2>
...
$qury_wallet = "SELECT *FROM wallet_confrim Where admin_confirm = '0' ";
...
?>
        ...
        <td><form action="admin_status_db.php" method="post" ><button type="submit" class="button" name = "update_wallet" value = "<?php echo $show_sql_wallet['wallet_id_confirm']; ?>" ><span>ยืนยัน</span></button>
        <button type="submit" class="button" name = "error_wallet" value = "<?php echo $show_sql_wallet['wallet_id_confirm']; ?>" ><span>รอตรวจสอบภายหลัง</span></button> 
