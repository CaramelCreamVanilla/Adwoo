...
$qury_cart_status = "SELECT *FROM product_type";
...
?>
        ...
        <td><?php echo $show_sql_cart['name_ty_prod'];?></td>
        <td>
        ...
        <form  method="post" action="admin_edit_product_type.php"><button type="submit" class="button" name = "edit_product_type" value = "<?php echo $show_sql_cart['prod_ty_id']; ?>" ><span>แก้ไขประเภทสินค้า</span></button></form>
        
        
        <form action="admin_delete_db.php" method="post" ><button type="submit" class="button" name = "delete_product_type" value = "<?php echo $show_sql_cart['prod_ty_id']; ?>" ><span>ลบประเภทสินค้า</span></button></form>
