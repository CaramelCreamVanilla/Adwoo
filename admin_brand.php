...
$qury_cart_status = "SELECT *FROM brands";
...
?>
        ...
        <td><?php echo $show_sql_cart['name_brand'];?></td>
        <td>
        ...
        <form  method="post" action="admin_edit_brand.php"><button type="submit" class="button" name = "edit_brand" value = "<?php echo $show_sql_cart['brand_id']; ?>" ><span>แก้ไขแบรนด์</span></button></form>
        
        
        <form action="admin_delete_db.php" method="post" ><button type="submit" class="button" name = "delete_brand" value = "<?php echo $show_sql_cart['brand_id']; ?>" ><span>ลบแบรนด์</span></button></form>
