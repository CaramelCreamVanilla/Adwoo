...
<body>
  <div class="gridsidebar">
    <div class="sidenav">
        ...
        <a href="editprofile.php">บัญชีของฉัน</a>
        <a href="status_db.php">สถานะตะกร้า</a>
        <a href="wallet_choice.php">เติมเงินในกระเป๋า</a>
        <a href="logout.php">ออกจากระบบ</a>
    </div>
    <form  method="post" action="editprofile_db.php">
    <div class="box">
        <div class="title"><h1><i class="fa-solid fa-user"></i> ข้อมูลส่วนตัว<h1></div>
      <div class="containerprofile">
        <div class="profiledetail">

          <h1>ชื่อ-นามสกุล</h1><input type="text" name="cus_name"  value="<?php echo  $cus_name;  ?>" required ><input type="text" name="cus_lastname" value="<?php echo   $cus_lastname ;  ?>" required>   </div>
      <div class="profiledetail">
          <h1>ที่อยู่</h1> <p><input type="text"  name="cus_address" value="<?php echo  $cus_address;  ?>" required ></p>
      </div>
      <div class="profiledetail">
          <h1>เบอร์โทร</h1> <p><input type="tel"  name="cus_tel" pattern="(0){1}[6,8,9]{1}[0-9]{8}" value="<?php echo  $cus_tel;  ?>" required></p>
      </div>
      <div class="profiledetail">
          <h1>อีเมล</h1> <p><input type="email"  name="cus_email" value="<?php echo  $cus_email;  ?>" required ></p>
      </div>

     <div class = "edit"> <button type="submit"  name = "edit_prod" value = "<?php echo $show_sql_cart['prod_id']; ?>"required ><span>บันทึกข้อมูล</span></button></div>
          </form>
